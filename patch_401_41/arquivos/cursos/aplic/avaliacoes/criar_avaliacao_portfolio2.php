...
-------------------------------------------------------------------------------
    ...
    Arquivo : cursos/aplic/avaliacoes/criar_avaliacao_portfolio2.php
...
/*==========================================================
  ...
  */
  ...
  $linha=RetornaDadosDoItem($sock, $cod_atividade);
  if ($linha['status']=="C")
  {
    ...
    AtualizaAvaliacaoTemporaria($sock, $tabela, $cod_usuario, trim($objetivos), trim($criterios),$tipo,$valor,$data_inicio,$data_termino,$cod_avaliacao);
  echo("<form action=../material/editar_material2.php?".RetornaSessionID()." method=post>\n");

  /* 76 - Avaliaï¿½o incluida com sucesso. */
  ...
  echo("  <input type=hidden name=cod_ferramenta value=3>");/*Atividades que perde a variavel de sessï¿½ quando aberta a ajuda*/

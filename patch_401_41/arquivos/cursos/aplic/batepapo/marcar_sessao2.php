    ...
    foreach ($lista as $cod => $linha)
    {
        ...
        || $data_fim>$linha['data_inicio'] && $data_fim<=$linha['data_fim'])
      {
       ...
       echo("    <td valign=\"top\">\n");
        ...
        echo("        <tr>\n");
        echo("          <td>".RetornaFraseDaLista($lista_frases,61)." \"".LimpaTitulo($assunto)."\" ".RetornaFraseDaLista($lista_frases,56)." ".Unixtime2DataHora($data_inicio)." ".RetornaFraseDaLista($lista_frases,57)." ".Unixtime2DataHora($data_fim).", ".RetornaFraseDaLista($lista_frases,62)." \"".$linha['assunto']."\" ".RetornaFraseDaLista($lista_frases,56)." ".Unixtime2DataHora($linha['data_inicio'])." ".RetornaFraseDaLista($lista_frases,57)." ".Unixtime2DataHora($linha['data_fim']).".</td>\n");
        echo("        </tr>\n");
        // Fim Tabela Interna
        echo("      </table>\n");
        echo("    </td>\n");

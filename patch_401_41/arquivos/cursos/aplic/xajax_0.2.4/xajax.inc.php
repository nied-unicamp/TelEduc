 ...
 * 
 * @package xajax
 * @version $Id: xajax.inc.php,v 1.1.1.1 2008/04/08 19:30:34 gabrielmdias Exp $
...
// 			$objResponse->addAlert("Unknown Pre-Function ". $this->sPreFunction);
        /* Erro Personalizado */
        $objResponse->addScriptCall("mostraFeedback", RetornaFraseDaLista($lista_frases, 80), 'true');

...
-------------------------------------------------------------------------------
    ...
    Arquivo : cursos/aplic/mural/apagar_assunto.php
...
/*==========================================================
  ...
  /* 29 - Apagar Assunto */
  $cabecalho .= "  <b class=subtitulo> - ".RetornaFraseDaLista($lista_frases, 29)."</b>";
  ...
  if (ApagaAssunto($sock, $cod_assunto))
  {
    /* 30 - Assunto apagado com sucesso. */
    echo("    <font class=text>".RetornaFraseDaLista($lista_frases,30)."</font>\n");
    echo("    <p>\n");
    /* 23 - Voltar */
    echo("    <input type=submit value='".RetornaFraseDaLista($lista_frases_geral, 23)."'>\n");
  }
  else /* Se o assunto NAO pode ser apagado apresenta uma mensagem de erro */
  {
    /* 31 - Erro ao apagar o assunto. */
    echo("    <font class=text>".RetornaFraseDaLista($lista_frases, 31)."</font>\n");
    echo("    <p>\n");
   /* 23 - Voltar */
    echo("    <input type=submit value='".RetornaFraseDaLista($lista_frases_geral, 23)."'>\n");
  }

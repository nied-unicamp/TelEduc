  ...
  */
  ...
  if ($curso_form == "sim")
  {
    ...
    */
    ...
    echo("        if (nome == '') \n");
    echo("        {\n");
    /* 137 - O campo 'Nome do Contatante' n�o pode ser vazio. */
    ...
    echo("        if (email == '') \n");
    echo("        {\n");
    /* 97 - O e-mail informado parece estar errado. Por favor verifique se voc� esqueceu o sinal '@' */
    ...
    echo("          if((email.indexOf(' ')>=0)) \n");
    echo("          {\n");
    /* 98 - O e-mail informado possui espa�os em branco. Por favor retire-os. */
    ...
    echo("        if (login == '') \n");
    echo("        {\n");
    /* 99 - O campo login n�o pode ser vazio. */
    ...
    echo("          {\n");
    /* 107 - O campo login n�o pode conter espa�os. */

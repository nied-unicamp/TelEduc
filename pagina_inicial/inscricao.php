...
/*==========================================================
  ...
  /* Caso o usuÃ¡rio naum esteja logado, direciona para pÃ¡igna de login */
  ...
  {
    /* 100 - Esse curso jï¿½ teve suas inscriï¿½ï¿½es encerradas. */
    echo("                  <tr>\n");
  ...
  else if(!ParticipaDoCurso($cod_curso))
  {
    ...
    /* 111 - Uma mensagem foi enviada para seu e-mail confirmando a inscriï¿½ï¿½o no curso. Caso nï¿½o o receba nas prï¿½ximas 24 horas, provavelmente significa que preencheu o e-mail errado. Neste caso, terï¿½ que fazer a inscriï¿½ï¿½o novamente. */
    echo("                  <tr>\n");
    echo("                    <td align=left>\n");

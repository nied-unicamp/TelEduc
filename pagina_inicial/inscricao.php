...
/*==========================================================
  ...
  else if(!ParticipaDoCurso($cod_curso))
  {
    ...
    /* 188 - Um pedido de matr�cula no curso */
    /* 189 - foi solicitado. */
    /* 190 - Para ver os dados do aluno, aceit�-lo no curso, aceit�-lo como visitante ou rejeitar o pedido, acesse o item Administra��o e, em seguida, Gerenciamento de Inscri��es desse curso. */
    /* 191 - Atenciosamente, Administra��o do Ambiente TelEduc. */

...
/*==========================================================
  ...
  if ($tipo_curso=="N")
    ...
    /* 7 - Cursos com inscriÁıes abertas */
    ...
    if (count($lista)>0 && $lista != "")
    {
      ...
      foreach($lista as $cod => $linha)
      {
        ...
        else
        {
       	 ...
       	 * Se o usuario tem acesso ao curso e o curso j√° come√ßou, tamb√©m pode. 
       	 */
...
//        	}
    ...
    else
    {
      ...
      /* 175 - curso com inscriÁ„o aberta */
      /* 176 - Curso encerrado */
      if ($tipo_curso=="N")
  ...
  else /* H· mais de uma pasta de cursos com cursos nela, e n„o se estÔøΩ dentro de nenhuma */
  {
    echo("          <table cellpadding=\"0\" cellspacing=\"0\" id=\"tabelaExterna\" class=\"tabExterna\">\n");
    echo("            <tr>\n");
    echo("              <td valign=\"top\">\n");

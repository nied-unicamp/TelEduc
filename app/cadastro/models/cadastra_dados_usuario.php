...
}else
{
	...
	$query="insert into Usuario (cod_usuario,login,senha,nome,rg,email,telefone,endereco,cidade,estado,pais,data_nasc,sexo,local_trab,profissao,cod_escolaridade,informacoes,data_inscricao,cod_lingua,confirmacao) values (".ConversorTexto::VerificaNumeroQuery($cod_usuario).",'".ConversorTexto::VerificaStringQuery($sock, $login)."','".ConversorTexto::VerificaStringQuery($sock, $senha)."','".ConversorTexto::VerificaStringQuery($sock, $nome_usuario)."','".ConversorTexto::VerificaStringQuery($sock, $rg)."','".ConversorTexto::VerificaStringQuery($sock, $email)."','".ConversorTexto::VerificaStringQuery($sock, $telefone)."','".ConversorTexto::VerificaStringQuery($sock, $endereco)."','".ConversorTexto::VerificaStringQuery($sock, $cidade)."','".ConversorTexto::VerificaStringQuery($sock, $estado)."','".ConversorTexto::VerificaStringQuery($sock, $pais)."','".ConversorTexto::VerificaStringQuery($sock, $data)."','".ConversorTexto::VerificaStringQuery($sock, $sexo)."','".ConversorTexto::VerificaStringQuery($sock, $local)."','".ConversorTexto::VerificaStringQuery($sock, $profissao)."','".ConversorTexto::VerificaStringQuery($sock, $cod_escolaridade)."','".ConversorTexto::VerificaStringQuery($sock, $informacoes)."','".time()."',1,'".ConversorTexto::VerificaStringQuery($sock, $sequencia)."')";

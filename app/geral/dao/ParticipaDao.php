<?php
 ...
 /**
  * Participa Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Participa object instances. 
  */
...
class ParticipaDao {
     ...
     */
    function getObject(&$conn, $cod_usuario, $cod_curso, $cod_papel) {
    ...
    function load(&$conn, &$valueObject) {
          ...
          $sql = "SELECT * FROM Participa WHERE (cod_usuario = ".$valueObject->getCod_usuario()." AND ";
          $sql = $sql."cod_curso = ".$valueObject->getCod_curso()." AND ";
          $sql = $sql."cod_papel = ".$valueObject->getCod_papel().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM Participa ORDER BY cod_papel ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO Participa ( cod_usuario, cod_curso, cod_papel, ";
          $sql = $sql."data_inscricao) VALUES (".$valueObject->getCod_usuario().", ";
          $sql = $sql."".$valueObject->getCod_curso().", ";
          $sql = $sql."".$valueObject->getCod_papel().", ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE Participa SET data_inscricao = ".$valueObject->getData_inscricao()."";
          $sql = $sql." WHERE (cod_usuario = ".$valueObject->getCod_usuario()." AND ";
          $sql = $sql."cod_curso = ".$valueObject->getCod_curso()." AND ";
          $sql = $sql."cod_papel = ".$valueObject->getCod_papel().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM Participa WHERE (cod_usuario = ".$valueObject->getCod_usuario()." AND ";
          $sql = $sql."cod_curso = ".$valueObject->getCod_curso()." AND ";
          $sql = $sql."cod_papel = ".$valueObject->getCod_papel().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function countAll(&$conn) {
          ...
          $sql = "SELECT count(*) FROM Participa";
          $allRows = 0;
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM Participa WHERE 1=1 ";
          ...
          if ($valueObject->getCod_papel() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND cod_papel = ".$valueObject->getCod_papel()." ";
          }
          ...
          $sql = $sql."ORDER BY cod_papel ASC ";
    ...
    function singleQuery(&$conn, &$sql, &$valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setCod_curso($row[1]); 
                   $valueObject->setCod_papel($row[2]); 
                   $valueObject->setData_inscricao($row[3]); 
          } else {
    ...
    function listQuery(&$conn, &$sql) {
          ...
          while ($row = $conn->nextRow($result)) {
               ...
               $temp->setCod_curso($row[1]); 
               $temp->setCod_papel($row[2]); 
               $temp->setData_inscricao($row[3]); 

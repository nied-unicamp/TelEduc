<?php
 ...
 /**
  * Tipo_permissao Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Tipo_permissao object instances. 
  */




class Tipo_permissaoDao {
     ...
     */
    function getObject(&$conn, $cod_tipo) {

          $valueObject = $this->createValueObject();
          $valueObject->setCod_tipo($cod_tipo);
    ...
    function load(&$conn, &$valueObject) {
          ...
          if (!$valueObject->getCod_tipo()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM Tipo_permissao WHERE (cod_tipo = ".$valueObject->getCod_tipo().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM Tipo_permissao ORDER BY cod_tipo ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO Tipo_permissao ( cod_tipo, nome) VALUES (".$valueObject->getCod_tipo().", ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE Tipo_permissao SET nome = '".$valueObject->getNome()."'";
          $sql = $sql." WHERE (cod_tipo = ".$valueObject->getCod_tipo().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM Tipo_permissao WHERE (cod_tipo = ".$valueObject->getCod_tipo().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function deleteAll(&$conn) {
          ...
          $sql = "DELETE FROM Tipo_permissao";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function countAll(&$conn) {
          ...
          $sql = "SELECT count(*) FROM Tipo_permissao";
          $allRows = 0;
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM Tipo_permissao WHERE 1=1 ";

          if ($valueObject->getCod_tipo() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND cod_tipo = ".$valueObject->getCod_tipo()." ";
          }

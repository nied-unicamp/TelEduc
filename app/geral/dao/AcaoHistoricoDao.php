...
<?php
 ...
 /**
  * Acao_Historico Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve Acao_Historico object instances. 
  */


class Acao_HistoricoDao {
     ...
     */
    function getObject(&$conn, $cod_acao) {

          $valueObject = $this->createValueObject();
          $valueObject->setCod_acao($cod_acao);
    ...
    function load(&$conn, &$valueObject) {
          ...
          if (!$valueObject->getCod_acao()) {
               //print "Can not select without Primary-Key!";
               return false;
          }

          $sql = "SELECT * FROM Acao_Historico WHERE (cod_acao = ".$valueObject->getCod_acao().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM Acao_Historico ORDER BY cod_acao ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO Acao_Historico ( cod_acao, nome) VALUES (".$valueObject->getCod_acao().", ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE Acao_Historico SET nome = '".$valueObject->getNome()."'";
          $sql = $sql." WHERE (cod_acao = ".$valueObject->getCod_acao().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM Acao_Historico WHERE (cod_acao = ".$valueObject->getCod_acao().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function deleteAll(&$conn) {
          ...
          $sql = "DELETE FROM Acao_Historico";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function countAll(&$conn) {
          ...
          $sql = "SELECT count(*) FROM Acao_Historico";
          $allRows = 0;
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM Acao_Historico WHERE 1=1 ";

          if ($valueObject->getCod_acao() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND cod_acao = ".$valueObject->getCod_acao()." ";
          }

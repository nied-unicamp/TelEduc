 ...
 *
 * Neste arquivo sใo recebidas algumas varias por post, incluindo titulo do compromisso da agenda.
 * Em seguida ้ obtido o usuแrio logado no sistema a partir da sessใo, depois as frases do idioma do usuario. 
 * Logo apos obtem os  diretorios base  de cada item (item ้ um nome de variavel usado dentro do sistema. Ex.: CaminhoCurso) na tabela Diretorios.
...
/* aรงรฃo = Criar Nova Agenda - origem = ver_editar.php */
if ($acao=="criarAgenda")
{

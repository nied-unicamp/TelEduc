...
{
	// 88 - Importando para:
	echo("          ".Linguas::RetornaFraseDaLista($lista_frases,88));
...
/*23 - (Geral) Voltar*/
echo("                  <li><span onClick=history.go(-1);>".Linguas::RetornaFraseDaLista($lista_frases_geral, 23)."</span></li>\n");
echo("                </ul>\n");
echo("              </td>\n");
echo("            </tr>\n");
echo("            <tr>\n");
...
echo("                  <tr class=\"head\">\n");
/*18 - Titulo */
echo("                    <td class=\"alLeft\" align=\"left\" width=\"82%\">".Linguas::RetornaFraseDaLista($lista_frases, 18)."</td>\n");
/*7 - Data */
echo("                    <td  align=\"center\">".Linguas::RetornaFraseDaLista($lista_frases, 7)."</td>\n");
echo("                  </tr>\n");
...
if(($linha_item['texto']!="")||($arquivo_entrada!=""))
{
	echo("                  <tr class=\"head\">\n");
	/* 91 - Conteudo  */
	echo("                    <td colspan=\"4\" align=\"left\">".Linguas::RetornaFraseDaLista($lista_frases,91)."</td>\n");
	echo("                  </tr>\n");
	echo("                  <tr>\n");
		...
		foreach($lista_arq as $cod => $linha)
		{
			...
			if ((!$linha['Status'])||($linha['Status']))
			{
				...
				if ($linha['Arquivo'] != "")
				{
					...
					if ($linha['Status'])
						// 59 - Entrada
						echo("<span id=\"arq_oculto_".$conta_arq."\">- <span style='color:red;'>".Linguas::RetornaFraseDaLista($lista_frases,59)."</span></span>");
					echo("</span>\n");
					echo("                          ".$espacos2."<br />\n");
					echo("                        ".$espacos2."</span>\n");
				}

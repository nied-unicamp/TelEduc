...
-------------------------------------------------------------------------------
    ...
    Arquivo : app/perfil/views/perfil.php
...
/* CÃ³digo principal */
  ...
  /* Se o número total de usuários for superior que o numero de usuários por  */
  /* página então calcula o total de páginas. Do contrário, define o número de     */
  /* páginas para 1.                                                           */

  /* Calcula o número de páginas geradas.    */
  ...
  /* atribui o valor de $total_pag à $pagAtual.                                    */
  ...
  */
  ...
  if (! $coord_como_form)
  {
    // o coordenador Ã© exibido como coordenador mesmo. Portanto descontamos o tamanho da lista de formadores de um (o coordenador)
    $total -= 1;
  }

...
echo("          <ul id=\"nav3nivel\">\n");
  ...
  echo("              <li class=\"visoes\"><a href=\"".$link."equipe.php\">"._("TEAM_-3")."</a></li>\n");
  if(empty($_SESSION['login_usuario_s']))
    echo("              <li class=\"visoes\"><a href=\"".$view_login."autenticacao_cadastro.php\">"._("LOGIN_-3")."</a></li>\n");
  else
    echo("              <li class=\"visoes\"><a href=\"".$ctrl_login."logout.php\">"._("LOGOUT_-3")."</a></li>\n");
  echo("            </map>\n");
  echo("          </ul>\n");
...
$lingua_pais=Linguas::LinguaLocal($sock,$cod_lin);
  ...
  echo("          </ul>\n");
	...
	* cod_texto=1 (-5): Administracao
	* cod_texto=18: Area Restrita
	* */
	if($_SESSION['cod_usuario_global_s'] == -1)
		echo("          <a href=\"".$view_admin."index_adm.php\" title=\""._("ADMINISTRATION_-5")." ("._("RESTRICTED_AREA_-3").")\"><img src=\"".$diretorio_imgs."btAdmin.gif\" border=\"0\" alt=\"Admin\" align=\"right\" style=\"position:relative; top:22px;\" /></a>\n");
  echo("          <h3>TelEduc</h3>\n");
  /* 236 - Ocorreu um erro na sua solicitação*/
  echo("          <div id=\"feedback\" class=\"feedback_hidden\"><span id=\"span_feedback\">"._("ERROR_IN_SOLICITATION_-3")."</span></div>\n");
  echo("        </td>\n");
  echo("      </tr>\n");
  echo("      <tr>\n");
  ...
  //echo("            <li><a class=\"Cabecalho\" href=\"".$link."teleduc.php\">TelEduc</a></li>\n");
	 ...
	 */
	echo("            <li><a href=\"".$link."teleduc.php\">"._("WHATS_TELEDUC_-3")."</a></li>\n");
  echo("            <li><a href=\"".$link."estrutura.php\">"._("ENVIRONMENT_STRUCTURE_-3")."</a></li>\n");
  /*Se nao estiver logado, deixa link pra se cadastrar*/
  if(empty($_SESSION['login_usuario_s']))
	if($cod_curso != NULL){
	//179 - Cadastre-se
	echo("            <li><a href=\"".$view_cadastro."cadastro.php?cod_curso=".$cod_curso."&tipo_curso=".$tipo_curso."\">"._("SIGN_UP_-3")."</a></li>\n");
    }else{
    //179 - Cadastre-se
    echo("            <li><a href=\"".$view_cadastro."cadastro.php\">"._("SIGN_UP_-3")."</a></li>\n");
    }
    ...
    /* 187 - Pessoal*/
    echo("            <div class=\"navCabecalho\">"._("PERSONAL_-3")."</div>\n");
    if(Usuarios::PreencheuDadosPessoais($sock))
    	/*
    	 * 132 - Meus cursos
    	 * 1 - Configurar
    	 */
    echo("            <li><a href=\"".$view_administracao."exibe_cursos.php\">"._("MY_COURSES_-3")."</a></li>\n");
    		echo("            <li><a href=\"".$link."dados.php\">"._("CONFIGURE_-7")."</a></li>\n");
    }
  echo("          </ul><ul id=\"nav\">");
  /* 
   * 5 - Cursos
   ...
   */
  echo("            <div class=\"navCabecalho\">"._("COURSES_-3")."</div>\n");
  echo("            <li><a href=\"".$view_administracao."cursos_all.php?tipo_curso=I\">"._("OPEN_ENROLLMENTS_-3")."</a></li>\n");
  echo("            <li><a href=\"".$view_administracao."cursos_all.php?tipo_curso=N\">"._("NOT_BEGUN_-3")."</a></li>\n");
  echo("            <li><a href=\"".$view_administracao."cursos_all.php?tipo_curso=A\">"._("CURRENT_-3")."</a></li>\n");
  echo("            <li><a href=\"".$view_administracao."cursos_all.php?tipo_curso=F\">"._("CLOSED_-3")."</a></li>\n");
  echo("            <li><a href=\"".$view_administracao."criar_curso.php\">"._("HOW_CREATE_COURSE_-3")."</a></li>\n");
  echo("          </ul>\n");
  echo("        </td>\n");
  echo("      </tr>\n");
  echo("      <tr>\n");

...
require_once 'menu_principal_tela_inicial.php';
...
*/
echo("                        <form id=\"formAutentica\" name=\"formAutentica\" action=\"".$diretorio_ctrlers."autenticacao_cadastro.php\" onSubmit=\"return(TestaNome(document.formAutentica));\" method=\"post\" >\n");
...
require_once ("rodape_tela_inicial.php");

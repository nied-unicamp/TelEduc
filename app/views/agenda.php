...
{
	if($usr_formador)
		$titulo="<a id=\"tit_".$linha_item['cod_item']."\" href=\"".$diretorio_views."ver_linha.php?cod_curso=".$cod_curso."&amp;cod_usuario=".$cod_usuario."&amp;cod_item=".$linha_item['cod_item']."&amp;origem=agenda\">".$linha_item['titulo']."</a>";
	else

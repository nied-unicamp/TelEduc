...
require_once $diretorio_models.'exibe_cursos.inc';
...
{
	AcessoSQL::Desconectar($sock);
	require_once $diretorio_views.'preencher_dados.php';/*?acao=preencherDados&atualizacao=true*/
	exit;
}
...
{
	Desconectar($sock);
	require_once $diretorio_views.'cursos_all.php';/*?tipo_curso=A*/
	exit;
}

<?php
 ...
 /**
  * CursoFerramenta Data Access Object (DAO).
  * This class contains all database handling that is needed to 
  * permanently store and retrieve CursoFerramenta object instances. 
  */

class CursoFerramentaDao {
     ...
     */
    function getObject(&$conn, $cod_curso, $cod_ferramenta) {
    ...
    function load(&$conn, &$valueObject) {
          ...
          $sql = "SELECT * FROM Curso_Ferramenta WHERE (Curso_cod_curso = ".$valueObject->getCod_curso()." AND ";
          $sql = $sql."Ferramenta_cod_ferramenta = ".$valueObject->getCod_ferramenta().") "; 
    ...
    function loadAll(&$conn) {
          ...
          $sql = "SELECT * FROM Curso_Ferramenta ORDER BY Curso_cod_curso ASC ";
    ...
    function create(&$conn, &$valueObject) {
          ...
          $sql = "INSERT INTO Curso_Ferramenta ( Curso_cod_curso, Ferramenta_cod_ferramenta) VALUES (".$valueObject->getCod_curso().", ";
    ...
    function save(&$conn, &$valueObject) {
          ...
          $sql = "UPDATE Curso_Ferramenta SET ";
          $sql = $sql." WHERE (Curso_cod_curso = ".$valueObject->getCod_curso()." AND ";
          $sql = $sql."Ferramenta_cod_ferramenta = ".$valueObject->getCod_ferramenta().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function delete(&$conn, &$valueObject) {
          ...
          $sql = "DELETE FROM Curso_Ferramenta WHERE (Curso_cod_curso = ".$valueObject->getCod_curso()." AND ";
          $sql = $sql."Ferramenta_cod_ferramenta = ".$valueObject->getCod_ferramenta().") ";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function deleteAll(&$conn) {
          ...
          $sql = "DELETE FROM Curso_Ferramenta";
          $result = $this->databaseUpdate(&$conn, $sql);
    ...
    function countAll(&$conn) {
          ...
          $sql = "SELECT count(*) FROM Curso_Ferramenta";
          $allRows = 0;
    ...
    function searchMatching(&$conn, &$valueObject) {
          ...
          $first = true;
          $sql = "SELECT * FROM Curso_Ferramenta WHERE 1=1 ";

          if ($valueObject->getCod_curso() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND Curso_cod_curso = ".$valueObject->getCod_curso()." ";
          }

          if ($valueObject->getCod_ferramenta() != 0) {
              if ($first) { $first = false; }
              $sql = $sql."AND Ferramenta_cod_ferramenta = ".$valueObject->getCod_ferramenta()." ";
          }


          $sql = $sql."ORDER BY Curso_cod_curso ASC ";
    ...
    function singleQuery(&$conn, &$sql, &$valueObject) {
          ...
          if ($row = $conn->nextRow($result)) {
                   ...
                   $valueObject->setCod_ferramenta($row[1]); 
          } else {

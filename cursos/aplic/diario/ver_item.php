...
/*==========================================================
  ...
  // atribui layer_renomear � variavel lay_renomear.                      
  ...
  /* Se o usu�rio for o propriet�rio do di�rio, cria as fun��es para   */
...
//  echo("        <td class=text colspan=2>".Enter2BR(Space2Nbsp(LimpaConteudo($item_dados['texto'])))."</td>\n");
  ...
  /* Se o usu�rio for o propriet�rio do di�rio, exibe os bot�es para   */
  /* editar, renomear e apagar o item.                                 */

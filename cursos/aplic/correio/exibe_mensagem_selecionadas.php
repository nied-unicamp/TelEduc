...
/* C�digo principal */
  ...
  */
  ...
  echo("        </td>\n");
  echo("      </tr>\n");
  if(count($arrayMsgs) > 0){
  foreach($arrayMsgs as $cod_msg){
    ...
    if($modoVisualizacao != 'L'){ 
      ...
      if (!($status_curso=='E' && !EFormador($sock,$cod_curso,$cod_usuario))){
        ...
        /* 71 - Responder */
        echo("                    <li><span onClick=\"Resposta(1,".$cod_msg.", 'yes');\">".RetornaFraseDaLista($lista_frases, 71)."</span></li>\n");
        /* 72 - Responder para todos os destinatários */
        echo("                    <li><span onClick=\"Resposta(2,".$cod_msg.",'yes');\">".RetornaFraseDaLista($lista_frases, 72)."</span></li>\n");
        /* 73 - Redirecionar */
        echo("                    <li><span onClick=\"Resposta(3,".$cod_msg.", 'yes');\">".RetornaFraseDaLista($lista_frases, 73)."</span></li>\n");
        /* 12 - Excluir */
    ...
    echo("                  <tr>\n");
    echo("                    <td class=\"alRight\" style=\"width:100px\">\n");
    /* 23 - Remetente*/
    ...
    echo("                  <tr>\n");
    echo("                    <td  style=\"width:100px\" class=\"alRight\" valign=\"top\">\n");
    /* 27 - Destinatario*/

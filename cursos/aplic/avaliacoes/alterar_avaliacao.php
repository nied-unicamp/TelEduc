...
/*==========================================================
  ...
  echo("      check=false;\n");
  /* 5 - Voc� digitou caracteres estranhos neste valor da atividade. */
  /* 6 - Use apenas d�itos de 0 a 9 e o ponto ( . ) ou a v�rgula ( , ) para o campo valor (exemplo: 7.5).*/
  /* 7 - Por favor retorne e corrija.*/
  echo("        alert('".RetornaFraseDaLista($lista_frases,5)."\\n".RetornaFraseDaLista($lista_frases,6)."\\n".RetornaFraseDaLista($lista_frases,7)."');\n");
  echo("        return(false);\n");
  echo("      }\n");
...
/*
    ...
    if ($VeioDaAtividade)
    {
      if (!strcmp($dados['Ferramenta'],'P'))
      {
        ...
        {
          $arquivo='index_avaliacao';  //para o caso de cancelar a avalia��o, ai deve ir para esse outro arquivo
        }
        else
          $arquivo=$origem;

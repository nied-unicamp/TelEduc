  ...
  if ((!strcmp($dados['Ferramenta'],'P')) && (!strcmp($dados['Tipo'],'G')))
  {
    ...
    if ($num_grupos > 0)
    {
      ...
      foreach ($lista_grupos as $cod_grupo => $nome)
      {
        ...
        // E sempre que avalia um grupo, todos os alunos do grupo recebem a mesma avalia�ao
        ...
        if ($foiavaliado)           //Ja existe uma nota atribuida
        {
          ...
          if ($usr_formador)
          {
            ...
            if ($nota=='')
            {
              ...
              {
                /* 65 - Avaliar */
                echo("      <a href=\"#\" onClick=\"return(AvaliarAlunoPortfolio(".$cod."));\">[".RetornaFraseDaLista($lista_frases,65)."]</a>");
              }
              else
              {
                echo("&nbsp;");
        ...
        else // nenhuma nota foi atribuida
        {
          ...
          if (($usr_formador)  && (!$SalvarEmArquivo))
          {
            ...
            /* 65 - Avaliar */
            echo(RetornaFraseDaLista($lista_frases,65)."</a></td>\n");
            echo("      <td class=\"text\" align=center>");
            echo("&nbsp;</td>\n");
          }

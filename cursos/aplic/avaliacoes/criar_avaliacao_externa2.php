...
-------------------------------------------------------------------------------
    ...
    Arquivo : cursos/aplic/avaliacoes/criar_avaliacao_externa2.php
...
/*==========================================================
 ...
 // echo("    document.atualizar.compartilhamento.value=top.opener.document.material.tipo_comp.value;\n");
  echo("    window.opener.location='avaliacoes.php?&cod_curso=".$cod_curso."&cod_avaliacao='+cod_avaliacao+'&cancelar_edicao_avaliacao=nao'\n");
  echo("  }\n");
  echo("</script>\n");

...
/*Variavel para controlar quando deve ou n�o fazer alguma coisa no evento onUnload*/
echo("var unload=1;\n");

/*Fun��o chamada quando a p�gina � descarregada*/
...
if ($dados['Ferramenta'] == 'E')
{
  ...
  {
    /* 179 - Indisponível*/  /* 180 - Corrigir dissertativas*/

...
/*Forms*/
echo ("    <form method=\"post\" name=\"frmImportar\" action='importar_agenda.php?cod_curso=" . $cod_curso . "&cod_usuario=" . $cod_usuario . "&cod_ferramenta=1'>\n");
...
if ((!$curso_compartilhado) && (false === ($cod_usuario_import = UsuarioEstaAutenticadoImportacao($cod_curso, $cod_usuario, $cod_curso_import, $opt)))) {
	...
	echo ("          <form method=\"post\" name=\"frmRedir\" action='importar_curso.php?cod_curso=" . $cod_curso . "&cod_usuario=" . $cod_usuario . "&cod_ferramenta=1'>\n");
	echo ("            <input type=\"hidden\" name=\"cod_curso\" value=\"" . $cod_curso . "\">\n");
	echo ("            <input type=\"hidden\" name=\"cod_categoria\" value=\"" . $cod_categoria . "\">\n");
...
echo ("                <ul class=\"btAuxTabs\">\n");
/* 2 - Cancelar (geral) */
echo ("                    <li><span onclick=\"window.location='agenda.php?&cod_curso=" . $cod_curso . "&cod_usuario=" . $cod_usuario . "&cod_ferramenta=1';\">" . RetornaFraseDaLista($lista_frases_geral, 2) . "</span></li>\n");
echo ("                </ul>\n");
echo ("              </td>\n");
echo ("            </tr>\n");
echo ("            <tr>\n");
...
echo ("                  <tr class=\"head\">\n");
// 78 - Agendas do curso:  
echo ("                    <td align=center>" . RetornaFraseDaLista($lista_frases, 78) . "&nbsp;\"" . $nome_curso_import . "\"</td>\n");
echo ("                  </tr>\n");
echo ("                  <tr>\n");
echo ("                    <td>\n");
if ($sucesso) {

...
/*==========================================================
  ...
  if ($cod_ferramenta==-1)
    ...
    $nome_ferramenta="Administraï¿½ï¿½o";
  else
...
//   global $cod_lingua_s;
  ...
  */
  ...
  /* *********************************************************************
  Funcao AlteraSalvar - JavaScript.  Altera o formulï¿½rio para submissï¿½o ï¿½ pï¿½gina seguinte.
    Entrada: nome_form = nome do formulï¿½rio que serï¿½ alterado
    Saida:   Nenhuma.
  */
  ...
  /* *********************************************************************
  Funcao AlteraAjuda - JavaScript.  Altera o formulï¿½rio para submissï¿½o ï¿½ pï¿½gina seguinte.
    Entrada: nome_form = nome do formulï¿½rio que serï¿½ alterado
    Saida:   Nenhuma.
  */
  ...
  */
  ...
  if (!$SalvarEmArquivo)
  {
    ...
    /* *********************************************************************
    Funcao ImprimirRelatorio - JavaScript. Imprime a pï¿½gina da Ajuda
      Entrada: Nenhuma.
      Saida:   Nenhuma.
    */

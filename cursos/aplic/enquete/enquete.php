...
/*==========================================================
  ...
  ***************************************************************/
  ...
  if (($tela_formador) && (($categ == 1) || $categ == 2)) //enquete EM ANDAMENTO ou ENCERRADA na vis� do formador 
  {
    /* Carrega data e hora final da enquete atual no formul�io para  Adiantada/Prorrogada*/

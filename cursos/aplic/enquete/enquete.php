...
-------------------------------------------------------------------------------
    ...
    Nied - Nucleo de Inform�ica Aplicada �Educa�o
...
/*==========================================================
  ...
  ********************************************/
  ...
  /* Impede o acesso a algumas secoes aos usuários que n�o s�o formadores. */
  ...
  /***************************************************************
  JAVASCRIPTS para as a�es dos layers
  ***************************************************************/
  ...
  if (($tela_formador) && ($categ == 0)) // enquete NAO_REALIZADA na vis�o do formador
  {
    // Vai para a p�gina de edi��o da enquete
  ...
  if (($tela_formador) && ($categ == 1)) // enquete em ANDAMENTO na vis�o do formador
  {  
    // Finaliza a enquete
  ...
  if (($tela_formador) && (($categ == 1) || $categ == 2)) //enquete EM ANDAMENTO ou ENCERRADA na vis�o do formador 
  {
    // Carrega data e hora final da enquete atual no formul�rio para  Adiantada/Prorrogada
    ...
    // 110 - Hor�rio de t�rmino inv�lido.
  ...
  {
	// In�cio da P�gina do Aluno, Visitante e Convidado
	switch($categ)
	{
		case 1:  
  ...
  else
  {
    ...
    while ($num < count($lista_enquetes))
    {
      ...
      // Se o usu�rio for formador ent�o cria links com acesso as op��es
      if ($tela_formador)
      {
	switch($categ)
	{
      ...
      else if ($categ == 1) //N�o formadores
      {
		echo("                    <td align=\"center\" valign=\"top\" class=\"botao2\">\n");
		echo("                      <ul>\n");
		// 21 - Ver

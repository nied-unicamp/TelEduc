...
/*==========================================================
  ...
  // Dado usuário é dono de uma resolução (e portanto pode 
  // editá-la) se foi ele ou alguém de seu grupo que a submeteu.
  ...
  else if($resolucao['submetida'] == 'S' && $resolucao['corrigida'] == 'N')
  {
    ...
    //Permite enviar novamente a resolução

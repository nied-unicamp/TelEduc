...
if(count($lista_arq) > 0 || $lista_arq != null)
{
	...
	foreach ($lista_arq as $cod => $linha_arq)
	{
		...
		//converte o o caminho e o nome do arquivo que vÃªm do linux em UTF-8 para 
		//ISO-8859-1 para ser exibido corretamente na pÃ¡gina.
...
if ((count($questoes)>0)&&($questoes != null))
{
	foreach ($questoes as $cod => $linha_item)
	{
		...
		{
			echo("                        <dt class=\"portletHeader\">Sua resposta</dt>\n");
			echo("                          <dd class=\"portletItem\">\n");
			...
			if($gabarito){
				/* ? - Gabarito */
			    echo("                        <dt class=\"portletHeader\">Gabarito</dt>\n");
			    echo("                          <dd class=\"portletItem\">\n");
			    echo($gabarito);
			    echo("                          </dd>\n");
			}

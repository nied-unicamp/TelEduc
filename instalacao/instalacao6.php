...
/*==========================================================
  ...
  ExibirCabecalho(6,"Instala��o Conclu�da");
  ...
  Paragrafo("1 - Dados da administra��o configurados com sucesso!");

  echo("<br/>\n");

  Paragrafo("O TelEduc est� agora instalado e pronto para uso!");

  Paragrafo("Para fechar a seguran�a dos diret�rios principais, n�o esque�a de executar o passo 5 da instala��o em LeiaMe.txt");

...
/*
  if (!is_readable($mimetypes))
    Voltar("<font color=red>O arquivo \"mime.types\" n�o possui permiss�o para leitura. Altere suas permiss�es para 644 e reinicie a instala��o</font>");
*/
  ExibirCabecalho(5,"Dados da administra��o do Ambiente");
  ...
  if ($sock==-1)
    Voltar("Erro inesperado! Reinicie a instala��o");
  ...
  echo("
    <script type=\"text/javascript\" language=javascript>
      function Valida()
      {
        ...
        if (host.indexOf('.')< 0) {
	  alert ('Por Favor, coloque o endere�o completo no nome da m�quina. Ex: www.nied.unicamp.br e n�o apenas nied');
          return false;
        }
        while (host.search(\" \") != -1)
          host = host.replace(/ /, \"\");
  ...
  Paragrafo("1 - Diret�rios configurados com sucesso!");

  echo("<br/>\n");

  Paragrafo("<b><font size=+1>Preencha os dados da administra��o abaixo:</font></b>");

  Paragrafo("O ambiente utiliza o usu�rio '<font color=\"#2a6686\">admtele</font>' para acesso � administra��o do ambiente (P�gina Inicial). Especifique uma senha para esse usu�rio e <b>utilize essas informa��es</b> para autentificar na Administra��o do ambiente.");

  CaixaSenha("Senha para a conta de administra��o do TelEduc (usu�rio '<font color=\"#2a6686\">admtele</font>'):","senha_admin");
  CaixaSenha("Confirme a senha do Administrador:","senha_conf");
  CaixaTexto("Nome da m�quina com TelEduc na rede (Ex. www.nied.unicamp.br): ","host",$nome_da_maquina); // teleduc por padr�o
  CaixaTexto("Nome do administrador: ","nome_admin",""); // teleduc por padr�o
  CaixaTexto("E-mail do administrador: ","mail_admin",""); // teleduc por padr�o
